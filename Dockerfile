...
RUN git clone -b disable-testing-mode https://github.com/taikoxyz/rbuilder.git /app/rbuilder
...
# Copy rbuilder binary from our local build stage
COPY --from=rbuilder /usr/local/bin/rbuilder /usr/local/bin/rbuilder
