...
pub fn check_anchor_signature(anchor: &TransactionSigned) -> Result<()> {
    ...
    let msg_hash: reth_primitives::revm_primitives::ruint::aliases::U256 = msg_hash.into();
    if sign.r() == *GX2 {
...
pub fn decode_ontake_extra_data(extradata: &[u8]) -> u8 {
    let basefee_ratio =
        reth_primitives::revm_primitives::ruint::aliases::U256::from_be_slice(extradata);
