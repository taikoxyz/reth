...
use reth_node_api::{EngineValidator, FullNodeTypes, NodeTypesWithEngine};
    ...
    TaikoEngineValidator: EngineValidator<Types::Engine>,
{
    ...
    fn build_validator(self, ctx: &BuilderContext<Node>) -> eyre::Result<Self::Validator> {
